...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='reading datasets and convert them to unified format.')
    parser.add_argument('-config', action = 'store', dest = 'config_file', help = 'please enter configuration file.',default = 'config/extract_conv_emotion.ini')
    ...
    if mode == 'download':
        ...
        align(params)
    elif mode == 'extract_cmusdk':
        reader = dataset.setup(params)
        reader.read_data_from_sdk()
    elif mode == 'extract_conv_emotion':
        from dataset.multimodal.conv_emotion_reader import read_conv_emotion_data
        read_conv_emotion_data(params.in_path,params.out_path,params.dataset_name, params.max_seq_len)
    elif mode == 'add_dialogue_act':
        from dataset.multimodal.conv_emotion_reader import add_dialogue_act
        add_dialogue_act(params.dataset_name,params.in_path,params.out_path,params.act_annotation_path)
